          ...
          >
            <thead>
              <tr>
                ...
                <th style={{ width: '180px' }}>PTP ID</th>
                {inputColumns.map((key) => (
        ...
        >
          <thead>
            <tr>
              ...
              <th style={{ width: showInputCols ? '180px' : '22%' }}>PTP ID</th>
