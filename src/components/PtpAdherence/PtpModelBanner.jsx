      ...
      <div className="banner-content">
          ...
          <div className="stats-grid">
            ...
            <div className="stat-card">
              ...
              <div className="output-badges">
                <span className="badge-high">Green — Likely kept</span>
                <span className="badge-medium">Amber — Borderline</span>
                <span className="badge-low">Red — Likely broken</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="banner-right">
          <div className="accuracy-card">
            ...
            <span className="accuracy-value">88.7%</span>
          </div>
        </div>
      </div>
    </div>
